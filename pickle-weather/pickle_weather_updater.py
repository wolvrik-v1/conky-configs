...
WIDGET_DIR = HOME / ".config/pickle-weather-widget"
CACHE_DIR = HOME / ".cache/conky"

CACHE_PATH = CACHE_DIR / "pickle_weather.lua"
ERROR_PATH = CACHE_DIR / "pickle_weather.error"
...
def fetch_json(url, parameters):
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "PickleWeatherConky/1.0",
        },
    )
