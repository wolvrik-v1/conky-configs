...
function conky_render_panel()
    ...
    -- Draw Centered Clock
    draw_text(time_str, clock_x, 43, "DS-Digital", 42, true, text_gray)
    ...
    draw_text(cpu .. "%", 46, 142, "DS-Digital", 28, true, text_gray)
    ...
    draw_text(ram .. "%", 46, 226, "DS-Digital", 28, true, text_gray)
    ...
    draw_text(temp .. " C", 32, 312, "DS-Digital", 28, true, text_gray)
    ...
    draw_text(system .. "%", 32, 390, "DS-Digital", 28, true, text_gray)
    ...
    draw_text(home .. "%", 32, 468, "DS-Digital", 28, true, text_gray)
    ...
    draw_text(up_speed, 30, 544, "DS-Digital", 21, true, text_gray)
    draw_text("Up", 106, 532, "Ubuntu", 11, false, text_gray)
    draw_dot(114, 548, 3.5, track_cyan)

    draw_text(down_speed, 30, 580, "DS-Digital", 21, true, text_gray)
    ...
    draw_text(tostring(updates), 36, 652, "DS-Digital", 28, true, text_gray)
