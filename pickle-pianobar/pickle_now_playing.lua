...
local COVER_PNG  = HOME_DIR .. '/.cache/conky/pickle_cover.png'
...
local function spawn_control()
    local dir = HOME_DIR .. '/.config/pickle-pianobar-widget'
    os.execute(string.format(
        'pgrep -f "pickle_cont[r]ol\\.py$" >/dev/null 2>&1 || '
            .. 'setsid %s/pickle_control.py </dev/null '
            .. '>>%s/pickle_control.log 2>&1 &',
        dir, dir
    ))
end
spawn_control()
