...
STATE = os.path.expanduser('~/.cache/conky/cyberdeck-adsb.status')
LINK = os.path.expanduser('~/.cache/conky/cyberdeck-adsb.link')
CONKY_GUARD = '[c]onky .*(cyberdeckrc|adsbradarrc)'
...
def fetch():
    req = urllib.request.Request(FETCH_URL, headers={'User-Agent': 'cyberdeck-adsb/1.0'})
