-- ############################################################
--  Pianobar Now Playing -- Cairo/Lua renderer (MetalSysMonitor style)
...
--  Reads from the pickle-pianobar-widget cache.
...
local COVER_PNG   = XDG_CACHE .. '/conky/pianobar_now_playing_cover.png'
...
-- ======================= PALETTE =============================
-- MetalSysMonitor family palette: cool black-metal greys only.
...
-- gauge face used by the MetalSysMonitor CPU gauges (GSECTIONS),
...
-- The MetalSysMonitor gauge needle: a rectangular HANDCOL bar sweeping
...
-- Machined bezel ring, identical to the MetalSysMonitor gauge bezel:
